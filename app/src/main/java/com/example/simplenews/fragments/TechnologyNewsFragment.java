...
import com.example.simplenews.viewmodels.TechnologyNewsViewModel;
...
public class TechnologyNewsFragment extends Fragment {
    ...
    private TechnologyNewsViewModel technologyNewsViewModel;
    ...
    public static TechnologyNewsFragment newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.technology_news_fragment, container, false);
    }
...
//        Getting and setting up the viewmodel
        technologyNewsViewModel = new ViewModelProvider(this).get(TechnologyNewsViewModel.class);
        technologyNewsViewModel.initTechnologyNewsViewModel();
...
//        This is not the way to do recyclerview click listeners but this will suffice for now
        newsRecyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(getContext(), newsRecyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        NewsRepository.openCustomChromeTab(getContext(), url, R.color.colorAccent);
                    }
        ...
        swipeRefreshLayout.setOnRefreshListener(() -> {
            technologyNewsViewModel.refreshTopHeadlines();
