...
public class ScienceNewsFragment extends Fragment {
    ...
    private ScienceNewsViewModel scienceNewsViewModel;
    ...
    public static ScienceNewsFragment newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.science_news_fragment, container, false);
    }
...
//        Getting and setting up the viewmodel
        scienceNewsViewModel = new ViewModelProvider(this).get(ScienceNewsViewModel.class);
        scienceNewsViewModel.initScienceNewsViewModel();

//        Setting up the observer for the top headlines live data
        scienceNewsViewModel.getScienceNewsReponse().observe(getViewLifecycleOwner(), newsResponse -> {
            ...
            if (newsResponse == null) {
                ...
                Timber.d("ScienceNewsViewModel Mutable live data change came back null");

            } else {
                ArrayList<Article> freshNewsArticles = (ArrayList<Article>) newsResponse.getArticles();
                Timber.d("ScienceNewsViewModel Mutable Live data changed was observed here it is: " + newsResponse.getArticles().toString());
...
//        This is not the way to do recyclerview click listeners but this will suffice for now
        ...
        swipeRefreshLayout.setOnRefreshListener(() -> {
            scienceNewsViewModel.refreshTopHeadlines();
