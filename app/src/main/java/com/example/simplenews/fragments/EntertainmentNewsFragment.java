...
public class EntertainmentNewsFragment extends Fragment {
    ...
    private EntertainmentNewsViewModel entertainmentNewsViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.entertainment_news_fragment, container, false);
    }
...
//        Getting and setting up the viewmodel
        entertainmentNewsViewModel = new ViewModelProvider(this).get(EntertainmentNewsViewModel.class);
        entertainmentNewsViewModel.initEntertainmentNewsViewModel();

//        Setting up the observer for the top headlines live data
        entertainmentNewsViewModel.getEntertainmentNewsResponse().observe(getViewLifecycleOwner(), newsResponse -> {
            ...
            if (newsResponse == null) {
                ...
                Timber.d("EntertainmentNewsViewModel Mutable live data change came back null");

            } else {
                ArrayList<Article> freshNewsArticles = (ArrayList<Article>) newsResponse.getArticles();
                Timber.d("Entertainment Mutable Live data changed was observed here it is: " + newsResponse.getArticles().toString());
...
//        This is not the way to do recyclerview click listeners but this will suffice for now
        ...
        swipeRefreshLayout.setOnRefreshListener(() -> {
            entertainmentNewsViewModel.refreshTopHeadlines();
